...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Txtbox_pseudo = new javax.swing.JTextField();
        ...
        Txtbox_pseudo.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtBox_mdp, javax.swing.GroupLayout.PREFERRED_SIZE, 238, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(Txtbox_pseudo, javax.swing.GroupLayout.PREFERRED_SIZE, 238, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(73, 73, 73))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(Txtbox_pseudo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        Bt_Annuler.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/stop.png"))); // NOI18N
        ...
        Bt_Connexion.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/play.png"))); // NOI18N
        Bt_Connexion.setText("CONNEXION");
        Bt_Connexion.setToolTipText("Se connecter à la fenetre d'accueil");
    ...
    private void Bt_ConnexionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Bt_ConnexionActionPerformed
        if (Txtbox_pseudo.getText().length() == 0 || txtBox_mdp.getPassword().length == 0) {
              ...
              try {
                J = (IAgent) Naming.lookup("rmi://localhost:1099/BANQUE");
              }
...
//, adresse de la machine du client et nom de l'objet distant du client pour pouvoir l'invoquer ult�rieurementult�
                if (J.connectAgent(Txtbox_pseudo.getText(), new String(txtBox_mdp.getPassword()))) {
            
                  fermer();    
                  //Constructeur graphique de la classe Client
                   C = new FormeGenerale();
                  Essai essai=new Essai();
                  SplashWindow splash=new SplashWindow(C,1500,essai); 
    ...
    private javax.swing.JTextField Txtbox_pseudo;
